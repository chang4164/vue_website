...
Vue.component("bannertop-el", {
  template : `
    <div id="top_banner">
      <div class="wrap">
        <h2 class="banner_title">지금부터 당신의 영화가 시작됩니다.</h2>
        <a href="#">오디션 참가</a>
      </div>
    </div>
  `
...
Vue.component("cont1-el", {
  data : () => {
    return {
      cont1 : ["죄 많은 소녀 (After My Death, 2019)", "소공녀 (Microhabitat, 2020)", "벌새 (House of Hummingbird, 2018)"]
    }
  },
  template : `
    <div id="section1">
      <div class="wrap">
        ...
        <ul class="cont_wrap">
          <li class="content" v-for="cont_tit in cont1">
            <div class="img_part">
...
Vue.component("bannermid-el", {
  template : `
    <div id="mid_banner">
      <div class="wrap">
        <h2 class="mid_banner_tit">Audition Schedule</h2>
  ...
  template : `
    <div id="section2">
      <div class="wrap">
        ...
        <ul class="cont_wrap">
          <li class="content" v-for="name in cont2">
            <div class="txt_part">
              <span>{{name}}</span>
              <a href="#">필모그래프</a>
            </div>
...
const navi_active = document.querySelector("#review .nav li");
navi_active.addEventListener("click", () => {
